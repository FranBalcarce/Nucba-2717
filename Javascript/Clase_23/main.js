...
class Serie extends Pelicula {
  ...
  reproducirCapitulo() {
    return `Reproducir capitulo ${this.capitulo} de la serie ${this.nombre}`;
  }
}
...
// console.dir(Persona.prototype);

Persona.prototype.saludar = function () {
  return `Hola Soy ${this.name} ${this.lastname}`;
};
// Se agrego algo nuevo adentro de la clase persona sin tener que ir a la clase y agregarle el .this
// console.log(cristiano.saludar());
